...
| `CAP-019` | Inferenza causale e Intervention | `FR-034`, `FR-088`, `FR-090`, `FR-091`, `FR-094`, `FR-095`, `FR-096`, `FR-098`, `NFR-030` | Manifest, identify-or-abstain, do(X), controfattuale AAP, separazione Action/Intervention, validity envelope e integrità coprono il runtime causale. |
...
| `ELM-070` | Counterfactual Query e Result | `FR-035`, `FR-095` | Il profilo è mantenuto nella baseline e il runtime applica abduction–action–prediction quando attivato. |
...
| `ELM-084` | Memory Policy e Memory Item | `FR-038`, `FR-118`, `FR-119` | Memory è tipizzata, governata e isolata dal retrieval; non diventa conoscenza canonica. |
